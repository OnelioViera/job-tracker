...
export const TaskForm: React.FC<TaskFormProps> = ({
  ...
  return (
    <form
      ...
      className="flex flex-col gap-4 p-4 border rounded bg-white shadow"
    >
      ...
      <div className="flex flex-col gap-1">
        ...
        <select
          ...
          onChange={handleChange}
        >
          <option value="Low" className="bg-gray-200 text-gray-800">
            Low
          </option>
          <option value="Medium" className="bg-orange-200 text-orange-800">
            Medium
          </option>
          <option value="High" className="bg-red-200 text-red-800">
            High
          </option>
        </select>
      </div>
      ...
      <div className="flex flex-col gap-1">
        ...
        >
          ...
          <option value="In Progress" className="bg-blue-200 text-blue-800">
            In Progress
          </option>
